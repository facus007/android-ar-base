...
public class HT03ACamera implements CameraIF {
	...
	public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
		...
		// Ignore it.
		if (mPausing || mMainActivity.isFinishing()) {
			return;
		}
...
//----------------------- Camera's method ------------------------
	...
	private void setCameraParameters() {
		...
		CameraConfigurationManager mgr = new CameraConfigurationManager(this.mMainActivity.getApplicationContext());
		mgr.initFromCameraParameters(mCameraDevice);
		//mParameters.setPreviewSize(mViewFinderWidth, mViewFinderHeight);
		//mParameters.setPreviewSize(320, 240);
		//mCameraDevice.setParameters(mParameters);
		mgr.setDesiredCameraParameters(mCameraDevice);
	}
	 ...
	 * Callback classes
	 */
	private final class OneShotPreviewCallback implements
